          ...
          <div style={{ display: "grid", gridTemplateColumns: "minmax(320px, 1fr) minmax(380px, 1.2fr)" }}>
            <div style={{ padding: 26 }}>
              ...
              <form onSubmit={onSubmit} style={{ marginTop: 18 }}>
                ...
                <button type="submit" className="btn primary" disabled={loading} style={{ width: "100%", marginTop: 14, borderRadius: 999, height: 44, fontWeight: 900 }}>
                ...
                <div style={{ display: "flex", gap: 12, marginTop: 14 }}>
                  <button type="button" onClick={() => setError("Google login will be added later.")} style={{ width: 44, height: 44, borderRadius: 999, display: "grid", placeItems: "center", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.14)", cursor: "pointer" }}>
                    <GoogleIcon />
                  </button>

                  <button type="button" onClick={() => setError("Discord login will be added later.")} style={{ width: 44, height: 44, borderRadius: 999, display: "grid", placeItems: "center", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.14)", cursor: "pointer", color: "rgba(243,244,248,0.92)" }}>
                    <DiscordIcon />
                  </button>
                </div>
